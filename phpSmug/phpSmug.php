...
class phpSmug {
	...
	function users_getTransferStats($Month, $Year)
	{
		...
		$this->request('smugmug.users.getTransferStats', array("SessionID" => $this->SessionID, "Month" => round($Month), "Year" => round($Year)));
	...
	function albums_getInfo($AlbumID, $Password = NULL, $SitePassword = NULL)
	{
	    ...
	    $this->request('smugmug.albums.getInfo', array("SessionID" => $this->SessionID, "AlbumID" => round($AlbumID), "Password" => $Password, "SitePassword" => $SitePassword));
	...
	function albums_getStats($AlbumID, $Month, $Year, $Heavy = FALSE)
	{
		...
		$this->request('smugmug.albums.getStats', array("SessionID" => $this->SessionID, "AlbumID" => round($AlbumID), "Month" => round($Month), "Year" => round($Year), "Heavy" => $Heavy));
		return $this->parsed_response ? $this->parsed_response['Album'] : FALSE;
	}
	...
	function images_get($AlbumID, $Heavy = FALSE, $Password = NULL, $SitePassword = NULL)
	{
		...
		$this->request('smugmug.images.get', array("SessionID" => $this->SessionID, "AlbumID" => round($AlbumID), "Heavy" => $Heavy, "Password" => $Password, "SitePassword" => $SitePassword));
	...
	function images_getURLs($ImageID, $TemplateID = NULL, $Password = NULL, $SitePassword = NULL)
	{
		...
		$this->request('smugmug.images.getURLs', array("SessionID" => $this->SessionID, "ImageID" => round($ImageID), "TemplateID" => round($TemplateID), "Password" => $Password, "SitePassword" => $SitePassword));
	...
	function images_getInfo($ImageID, $Password = NULL, $SitePassword = NULL)
	{
		...
		$this->request('smugmug.images.getInfo', array("SessionID" => $this->SessionID, "ImageID" => round($ImageID), "Password" => $Password, "SitePassword" => $SitePassword));
		return $this->parsed_response ? $this->parsed_response['Image'] : FALSE;
	}
	...
	function images_getEXIF($ImageID, $Password = NULL, $SitePassword = NULL)
	{
		...
		$this->request('smugmug.images.getEXIF', array("SessionID" => $this->SessionID, "ImageID" => round($ImageID), "Password" => $Password, "SitePassword" => $SitePassword));
		return $this->parsed_response ? $this->parsed_response['Image'] : FALSE;
	}
	...
	function images_delete($ImageID)
	{
		...
		$this->request('smugmug.images.delete', array("SessionID" => $this->SessionID, "ImageID" => round($ImageID)));
		return $this->parsed_response ? $this->parsed_response['stat'] : FALSE;	
	}
	...
	function images_getStats($ImageID, $Month)
	{
		...
		$this->request('smugmug.images.getStats', array("SessionID" => $this->SessionID, "ImageID" => round($ImageID), "Month" => round($Month)));
		return $this->parsed_response ? $this->parsed_response['Image'] : FALSE;
	}
	...
	function subcategories_get($CategoryID, $NickName = NULL, $SitePassword = NULL)
	{
		...
		$this->request('smugmug.subcategories.get', array("SessionID" => $this->SessionID, "CategoryID" => round($CategoryID), "NickName" => $NickName, "SitePassword" => $SitePassword));
